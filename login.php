  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-sm-offset-4">
            ...
            <form class="login">
              ...
              <button onclick="window.location.href='index.html'" class="btn btn-default">
                返回主畫面
              </button>
            </form>
          </div>
    ...
    <script>
      ...
      $(document).on("ready", function() {
            ...
            {
              //註冊新增成功，轉跳到登入頁面。
              window.location.href = "admin/index.html"; //因為目前的 login.php 跟後端的 index.php 首頁在同一資料夾，所以直接叫他就好
            }
            else
            {
              alert("登入失敗，請確認帳號密碼");
